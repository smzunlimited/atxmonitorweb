...
import Meter from "./components/meterpage";
import Incoming from "./components/incomingpage";
import Outgoing from "./components/outgoingpage";
import Peakuse from "./components/peakusepage";
import Transfer from "./components/transferpage";
    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="p-4 xl:ml-80">
        ...
        <div>
          <>
            {selectedItem === "dashboard" && (
              <DashboardContent uid={uid} onPageChange={handlePageChange} />
            )}
            ,
            {selectedItem === "meter" && (
              <Meter onPageChange={handlePageChange} />
            )}
            ,
            {selectedItem === "incoming" && (
              <Incoming onPageChange={handlePageChange} />
            )}
            ,
            {selectedItem === "outgoing" && (
              <Outgoing onPageChange={handlePageChange} />
            )}
            ,
            {selectedItem === "peakuse" && (
              <Peakuse onPageChange={handlePageChange} />
            )}
            ,
            {selectedItem === "transfer" && (
              <Transfer onPageChange={handlePageChange} />
            )}
          </>
        </div>
      </div>
